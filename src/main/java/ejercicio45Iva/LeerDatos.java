...
public class LeerDatos {
	...
	public int IntroducirYValidarTipoDeProducto(Scanner reader, TipoIVA [] arrayTiposIVA, Producto [] arrayProductos)
	{
		...
		//Inicio de programa
			...
			tipoProducto = RecogerOpcionInt(reader,0,100, "Introduce tipo de producto: " );
			do
				{
				for(int i = 0;i<arrayTiposIVA.length;i++)
				{
				
					if(arrayTiposIVA[i].getIdTipo() == tipoProducto)
					{
				...
				}while(productoEncontrado==false);
